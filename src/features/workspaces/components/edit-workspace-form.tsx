...
export const EditWorkspaceForm = ({ onCancel, initialValues }: Props) => {
  ...
  const [ResetDialog, confirmReset] = useConfirm(
    "Reset invite link",
    "This will invalidate the current invite link and generate a new one. Are you sure you want to reset it?",
    "destructive"
  );
  ...
  const { mutate: deleteMutate, isPending: isDeleting } = useDeleteWorkspace();
